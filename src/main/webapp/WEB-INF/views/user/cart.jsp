              ...
              %>
                ...
                <tr>
                  <td class="image" data-title="No">
                    <img src="${pageContext.request.contextPath}/assets/user/images/anhcho/${pet.image}" alt="#" />
                  </td>
                  <td class="product-des" data-title="Description">
                    <p class="product-name"><a href="#">${pet.petName}</a></p>
                    <p class="product-des">
                      ${pet.description}
                    </p>
                  </td>
                  ...
                  <td class="action" data-title="Remove">
                    <a href="${pageContext.request.contextPath }/cart?action=removeToCart&id=<%= ++i %>"><i class="ti-trash remove-icon"></i></a>
                  </td>
                </tr>
</c:forEach>
              </tbody>
            ...
            <div class="total-amount">
              <div class="row">
                  ...
                  <div class="left">
                    ...
                    <div class="checkbox">
                      <label class="checkbox-inline" for="2"
                        ><input name="news" id="2" type="checkbox" /> Giao hàng
                        (+100 nghìn đồng)</label
                      >
                    </div>
                  </div>
                </div>
                <div class="col-lg-4 col-md-7 col-12">
                  <div class="right">
                    <ul>
                      <li>Tổng giỏ hàng<span>$330.00</span></li>
                      <li>Phí giao hàng<span>Free</span></li>
                      <li>Phí đảm bảo<span>$20.00</span></li>
                      <li class="last">Tổng<span>$310.00</span></li>
                    </ul>
                    <div class="button5">
